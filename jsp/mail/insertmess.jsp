...
<%	response.setContentType("text/html");
	...
	try
	{
			...
			ps=con.prepareStatement("insert into messdetail(from1,to1,subject,message,date) values(?, ?, ?, ?, ?)");
			...
			ps.setString(5,str);
			ps.executeUpdate();
			ps=con.prepareStatement("insert into sentdetail(from1,to1,subject,message,date) values(?, ?, ?, ?, ?)");
			ps.setString(1,from1);
			ps.setString(2,to1);
			ps.setString(3,subject);
			ps.setString(4,message);
